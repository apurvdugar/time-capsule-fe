  ...
  return (
    <>
      <section className="flex flex-col items-center justify-center h-[90vh] p-4 md:p-8">
        <div className="flex flex-col items-center justify-center text-center max-w-4xl mx-auto px-4 space-y-4">
          <h1 className="text-4xl md:text-6xl lg:text-8xl font-bold text-white mb-4">Send a Message to Your Future Self</h1>
